...
import Graphics.CompetitionType;
...
public class LetsDraw {
     ...
     */
    public LetsDraw(Animal[][] anis, CompetitionType cmptype){
        animals=anis;
            ...
            switch (ani.getOrien()) {
                case EAST:
                    if (p1.getX() + dis > 705) {
                        ...
                        dis=dis-(705-p1.getX());
                        ani.setOrien(Orientation.SOUTH);
                    }
                    else {
                ...
                case SOUTH:
                    if (p1.getY() + dis > 605) {
                        ani.setLocation(new Point(705, 605));
                        dis=dis-(605-p1.getY());
                        ani.setOrien(Orientation.WEST);
                    }
                    else {
                ...
                case WEST:
                    if (p1.getX() - dis < 1) {
                        ...
                        dis=dis-(dis-p1.getX());
                        ani.setOrien(Orientation.NORTH);
                    }
                    else {
                        ani.setLocation(new Point(p1.getX() - dis, p1.getY()));
                        dis=0;
